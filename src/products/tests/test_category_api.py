...
class CategoryAPITests(APITestCase):
    def setUp(self):
        self.cat1 = Category.objects.create(name="Ropa", description="Prendas de vestir")
        self.cat2 = Category.objects.create(name="Calzado", description="Zapatos y zapatillas")
